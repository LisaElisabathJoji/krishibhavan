    ...
    <div class="mt-5">
      <div class="card mx-auto text-center" style="width: 24rem;">
        <div class="card-body">
          ...
          $sql = "SELECT name,email,phonenumber FROM tb_userreg  where email='$eemail'";
        ...
        <div class="events"><a href="editprofile.php" class="btn btn-primary" style="width: 100%;">Edit Profile</a></div>
        <div class="events"><a href="updpass.php" class="btn btn-primary" style="width: 100%;">Update password</a></div>
      </div>
    </div>
