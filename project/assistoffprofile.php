        ...
        <div class="card-body">
          ...
          if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<p class=card-text>" . "Phone Number : " . $row['phone'] . "</p>";
            }
          }
          ?>
        </div>

        <div class="events"><a href="assistoffeditprofile.php" class="btn btn-primary" style="width: 100%;">Edit Profile</a></div>
        <div class="events"><a href="" class="btn btn-primary" style="width: 100%;">Update password</a></div>
      </div>
    </div>
