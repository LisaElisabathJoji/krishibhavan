        ...
        <div class="container">
          <div class="row">
              ...
              <div class="sidebar sidebar-left">
                <div class="widget">
                  ...
                  <ul class="nav service-menu">
                    ...
                    <li class="active"><a href="#">View Base Price Requests</a></li>
            ...
            <div class="col-xl-8 col-lg-8">
              <div class="container">
                <h4 class="bg-success text-light">Base Price Requests</h4>
                <?php
                $query = "SELECT * FROM tbl_baseprice";
                ...
                ?>
                  ...
                  echo "<td>" . $row['cropnumber'] . "</td>";

                  ?>
                  <td><img src="images/<?php echo $row["photo"] ?>" height="100" width="100"></img></td>
                <?php
