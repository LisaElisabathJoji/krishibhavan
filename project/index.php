            ...
            <div class="container h-100">
              <div class="row align-items-center h-100">
                <div class="col-md-12 text-center">
                  <h5 class="slide-sub-title" data-animation-in="slideInRight">Agricultural Information Management System</h5>
                    <p data-animation-in="slideInLeft" data-duration-in="1.2">Department of Agriculture Development and Farmers' Welfare</p>
                    <a href="services.html" class="slider btn btn-success">Services</a>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="row align-items-center h-100">
                <div class="col-md-12">
                  ...
                  <div data-animation-in="slideInLeft">
                    <a href="contact.html" class="slider btn btn-success" aria-label="contact-with-us">Contact Us</a>
                    <a href="about.html" class="slider btn btn-success border" aria-label="learn-more-about-us">Learn more</a>
                  </div>
                </div>
              </div>
            </div>
