...
if (isset($_SESSION["id"]) != session_id()) {
  ...
  if (isset($_POST["submit"])) {
    ...
    $landar = $_POST["larea"];
    $landav = $_POST["stype"];
    //$apstatus = $_POST["status"];
    $user_id = $_SESSION["userid"];

    mysqli_query($con, "INSERT INTO `tbl_soiltest`( `user_id`,`surveynumber`, `landname`, `landarea`, `soiltype`, `date`) VALUES ('$user_id','$survn','$landn','$landar','$landav', now())");
...
================================================== -->
          ...
          <div class="row">
              ...
              <div class="sidebar sidebar-left">
                <div class="widget">
                  ...
                  <ul class="nav service-menu">
                    <li class="active"><a href="#">Soil Test Application</a></li>
                    <li><a href="viewtestreq.php">View requests made</a></li>
            ...
            <div class="col-xl-8 col-lg-8">
              <div class="content-inner-page">
                ...
                <h3 class="bg-secondary text-light font-weight-light">Apply for Soil Test</h3>
                ...
                <div class="container">
                  ...
                  <form action="#" method="POST">
                    ...
                    <div class="form-group">
                      <label for="desc">Land Name/Type</label>
                    ...
                    <div class="form-group">
                      <label for="desc">Soil Type</label>
                      <input type="text" class="form-control" id="stype" name="stype" onblur="validate3()" required />
                      <label><span class="textfieldRequiredMsg"></span></label>
                    </div>
  ...
  ================================================== -->
    ...
    <script>
      ...
      function validate3() {
        var name = document.getElementById("stype").value;
        var letters = /^[a-zA-Z\s]*$/;
        if (!name.match(letters)) {
