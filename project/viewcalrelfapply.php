        ...
        <div class="container">
          <div class="row">
              ...
              <div class="sidebar sidebar-left">
                <div class="widget">
                  ...
                  <ul class="nav service-menu">
                    <li><a href="calreapply.php">Crop Insurance Apply</a></li>

                    <li class="active"><a href="#">Crop Insurance Requests</a></li>
            ...
            <div class="col-xl-8 col-lg-8">
              <div class="container">
                <h4 class="bg-success text-light">Crop Insurance Requests</h4>
                <?php
                $query = "SELECT * FROM tbl_cropinsurance";
                ...
                echo "<th>Seeds(in grams)</th>";
                // echo "<th>Least No.</th>";
                echo "<th>Age for Insurance</th>";
                ...
                ?>
                  ...
                  //echo "<td>" . $row['leastno'] . "</td>";
                  echo "<td>" . $row['ageforinsurance'] . "</td>";
                  echo "<td>" . $row['date'] . "</td>";
